...
class DeepLab_V3(nn.Module):
    def __init__(self, n_class):
        ...
        self.aspp = ASPP(num_classes=self.num_classes, output_stride=8) # NOTE! if you use ResNet50-152, set self.aspp = ASPP_Bottleneck(num_classes=self.num_classes) instead
